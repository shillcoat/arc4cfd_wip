...
![Sketch of the SSH client and server.](/src/assets/figs_section1/ssh-sketch.png)
...
![Sketch showing login nodes as the access point to the cluster.](/src/assets/figs_section1/Login.png)
...
![Sketch of the purpose of the job scheduler.](/src/assets/figs_section1/scheduler.png)
...
![Figure demonstrating the role of the job scheduler on the cluster.](/src/assets/figs_section1/Slurm.png)
